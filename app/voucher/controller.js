      ...
      if (req.file) {
        ...
        src.on("end", async () => {
          try {
            ...
            req.flash("alertMessage", "input voucher has been succeeded");
      ...
      if (req.file) {
        ...
        src.on("end", async () => {
          try {
            ...
            req.flash("alertMessage", "update voucher has been succeeded");
            req.flash("alertStatus", "success");
